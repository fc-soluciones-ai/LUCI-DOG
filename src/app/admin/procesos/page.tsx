    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-slate-600">
          ...
          un proceso vinculado se rastrea en el Dashboard TV; sin proceso, sigue el flujo simple de siempre.
          Arrastra los subprocesos para reordenarlos y haz clic en la duración de una etapa para editarla.
        </p>
      </div>

      <div className="space-y-6">
        {pipelines.length === 0 && <p className="text-sm text-slate-500">Sin procesos todavía.</p>}
            ...
            <div className="mt-4 space-y-3">
              {pipeline.steps.map((step) => (
                <div key={step.id} className="rounded border border-slate-200 p-3">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium text-slate-900">
                      ...
                      <InlineDurationEditor
                        ...
                        initialMinutes={step.standardDurationMin}
                        onSave={updateProcessStepDurationAction}
                      />
                    </p>
                  ...
                  <SubProcessList
                    items={step.subProcesses}
                    onReorder={reorderSubProcessesAction}
                    onDelete={deleteSubProcessAction}
                  />
      ...
      <details>
        <summary className="cursor-pointer text-sm font-medium text-slate-700">+ Nuevo proceso</summary>
